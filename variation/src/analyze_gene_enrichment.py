...
def _test_cand_gene_enrichment_():
	...
	res_files.append((env.env['results_dir'] + 'dilkes_pid7_25-DHBAg_emmax_sqrt_trans.pvals', '25-DHBAg'))
	res_files.append((env.env['results_dir'] + 'dilkes_pid8_23-DHBAg_emmax_log_trans.pvals', '23-DHBAg'))
