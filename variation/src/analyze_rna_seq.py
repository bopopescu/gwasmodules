...
def run_gwas(file_prefix, phen_file, start_i, stop_i, temperature, mac_threshold=15, filter_threshold=0.02,
	...
	for i, pid in enumerate(pids):
		...
		#Check 1 mb, 100kb, 50kb, 25kb, 10kb, 5kb, 0kb
		sd.get_local_n_global_kinships(focal_chrom_pos, window_size, kinship_method, global_kinship, verbose)
		#Check TSS, 100kb, 50kb,25kb, 10kb,5kb,0kb, (all upstream)
		#Check introns 
		#Check exons 
		lm.local_vs_global_mm(phen_vals, local_k, global_k)
...
#	plot(min_score=7, temperature=16, mapping_method='KW')
