...
Examples:
	...
	CheckCandidateGeneRank.py -s ~/mnt2/panfs/250k/snps_context_g0_m20000 -m 20000 -e 1-186 -l 28
		-o /tmp/hist_of_results_by_gene_candidate_score_rank/ -j 17 --commit
	...
	CheckCandidateGeneRank.py -s ~/mnt2/panfs/250k/snps_context_g0_m20000 -m 20000 -e 1-186 -l 28  -j 17 --commit -y 2
				...
				try:
					...
					if self.null_distribution_type_id==1:
						if self.results_type==1:
							...
							score_rank_data = self.getScoreRankFromRBG(rm, candidate_gene_set, self.data_dir)
