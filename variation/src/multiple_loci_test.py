...
def _update_sw_stats_(res_dict, step_info_list, opt_dict, c_chr, c_pos, l_chr=None, l_pos=None, significance_threshold=None, type='LM'):
	"""
	...
	for criteria in ['mbonf', 'mbic', 'ebic']:
		...
		#dist matrix
		#tprs.. for mbonf and ebic
		#perc. variance explained for criteria
		#pseudo-heritability for criteria
		#ks, and median pval for criteria 
