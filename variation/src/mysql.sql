...
create or replace view view_array as select a.id as array_id, a.median_intensity, a.filename, 
...
-- 2009-11-25 view stock_250k.view_array_quartile
create or replace view view_array_quartile as select a.id as array_id,  
	a.original_filename as array_filename,  a.maternal_ecotype_id,
	e1.nativename as maternal_nativename, e1.stockparent as maternal_stockparent,
	a.paternal_ecotype_id, e2.nativename as paternal_nativename,
	e2.stockparent as paternal_stockparent, a.date_created as array_created, aq.start_probe_id,
	aq.stop_probe_id, aq.no_of_probes, aq.minimum, aq.first_decile,
	aq.lower_quartile, aq.median, aq.upper_quartile, aq.last_decile, aq.maximum,
	aq.dlrspread 
	from array_info a, stock.ecotype e1,
	stock.ecotype e2, array_quartile aq where e1.id=a.maternal_ecotype_id and e2.id=a.paternal_ecotype_id 
